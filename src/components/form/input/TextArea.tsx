...
const TextArea: React.FC<TextareaProps> = ({
  ...
  let textareaClasses = `w-full rounded-lg border px-3.5 py-2 text-xs sm:text-sm shadow-theme-xs placeholder:text-xs placeholder:text-gray-400 focus:outline-hidden ${className} `;
