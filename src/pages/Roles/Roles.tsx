...
import { Role, AddRole } from "../../interfaces/role";
import { roleApi } from "../../api/roleApi";
import { toast } from "react-toastify";
import { Download, Plus, Shield as EntityIcon, X, Loader2 } from "lucide-react";
...
export default function Roles() {
  ...
  const [form, setForm] = useState<AddRole>({ role_name: "" });
  ...
  return (
    <div className="bg-[#fcfdff] min-h-screen pb-10">
      <PageMeta title="Roles Management | MOEE" description="Roles Management Page" />

      <div className="px-4 sm:px-8 py-8 max-w-[1400px] mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-bold text-[#0f172a] tracking-tight">Roles</h1>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm flex items-center gap-5">
            ...
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Total Roles</p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col animate-in zoom-in-95 duration-200">
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                <h2 className="text-[17px] font-extrabold text-gray-900">Add New Role</h2>
                <button 
              ...
              <div className="p-6">
                <div className="mb-4">
                  <label className="block text-[13px] font-bold text-gray-700 mb-2">Role Name <span className="text-red-500">*</span></label>
                  <input
                    type="text"
